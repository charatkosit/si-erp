...
| D-019 | 2026-09-24 | CONFIRMED | ผู้ใช้อนุมัติให้ P0-05 ใช้ MinIO development defaults ที่ไม่ใช่ production ชั่วคราว; P0-06 ต้องแทนที่ด้วย `.env.example` และ secret policy | ผู้ใช้/เจ้าของโครงการ ผ่านคำตอบ “ได้” ใน task นี้ | ปลด B-P0-05-02; ห้ามใช้ defaults นี้ใน staging/production | docs/specs/P0-05.md |
